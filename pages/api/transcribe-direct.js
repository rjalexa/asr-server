...
async function transcribeWithWhisperService(audioBuffer, filename, model, language) {
  ...
  try {
    ...
    console.log(`[Direct API] Making request to Whisper service: ${url}`)
    console.log(`[Direct API] Model: ${model}, Language: ${language}`)
    ...
    console.log('[Direct API] Whisper service response received')
    ...
    console.error('[Direct API] Whisper service error:', error)
...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.log(`[Direct API] Processing audio file: ${req.file.originalname}, size: ${req.file.size} bytes`)
    console.log(`[Direct API] Using model: ${model}, language: ${language}`)
    ...
    console.log(`[Direct API] Transcription complete for ${req.file.originalname}`)
    ...
    console.error('[Direct API] Transcription error:', error)
